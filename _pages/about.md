...
by reimplementing the game fully in C++. As of September 2025, the reimplementation efforts are
[fully completed](https://openloco.io/news/2025/09/openloco-v25.09.html). This means the game can now be compiled 
for different architectures (e.g. 64-bit Intel or ARM) as well as different platforms (e.g. Windows, Linux, macOS).
