...
As we previously mentioned, as of [v25.09](/news/2025/09/openloco-v25.09.html),
...
[this link](github.com/OpenLoco/OpenLoco/pulls?q=is%3Apr+milestone%3Av25.11+interop+OR+global+OR+buffer+OR+loco_globals)
...
- @shusaura85 replaced `ROADRGH` with `OG_ROADRGH`:

![OG_ROADRGH](/assets/img/25.11/og_roadrgh.png)

### Bridges

- @shusaura85 replaced `BRDGBRCK` with `OG_BRDGBRCK`:

![OG_BRDGBRCK](/assets/img/25.11/og_brdgbrck.png)

- @shusaura85 replaced `BRDGWOOD` with `OG_BRDGWOOD`:

![OG_BRDGWOOD](/assets/img/25.11/og_brdgwood.png)

### Land/CliffEdge

@hibiii added a *new* land type called `OG_VOID`, as well as the corresponding CliffEdge for it, `OG_LSVOID`:

![OG_VOID](/assets/img/25.11/og_void.png)

### Vehicles

@glenjimen replaced `CATTLE1` with `OG_CATTLE1`:

![OG_CATTLE1](/assets/img/25.11/og_cattle1.png)

@glenjimen replaced `GOODS3` with `OG_GOODS3`:

![OG_GOODS3](/assets/img/25.11/og_goods3.png)

@phosporus551 replaced `CL71` with `OG_CL71`:

![OG_CL71](/assets/img/25.11/og_cl71.png)

@phosporus551 updated `OG_RE441` with new sprites from a new rendering pipeline:

![OG_RE441](/assets/img/25.11/og_re441.png)

@phosporus551 replaced `RE442` with `OG_RE442`:

![OG_RE444](/assets/img/25.11/og_re442.png)

@phosporus551 updated `OG_656` with new sprites from a new rendering pipeline:

![OG_656](/assets/img/25.11/og_roadrgh.png)

@phosporus551 replaced `460` with `OG_460`:

![OG_460](/assets/img/25.11/og_460.png)

@phosporus551 replaced `EWIV` with `OG_EWIV`, as well as the corresponding `EWIVDT` with `OG_EWIVDT`:

![OG_EWIV](/assets/img/25.11/og_ewiv.png)
