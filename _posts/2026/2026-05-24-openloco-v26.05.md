...
In particularly, this also impacted how cargo stats were calculated, since it used the _old_ data,
...
As of this [#3742](https://github.com/OpenLoco/OpenLoco/pull/3742), this became a reality!
Many files were moved around to realise this! We now build the source tree as a library,
with the main game file executable using (linking) this library
