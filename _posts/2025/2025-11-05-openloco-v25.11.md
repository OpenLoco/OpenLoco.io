...
memory space, and the OpenGraphics project is also seeing big progress. Let's dig in!
...
@LeeSpork discovered that it was possible for players to interfere with competitors' roads.
...
Over the course of the literal *years* we've worked on OpenLoco, some parts of the codebase
...
[this link](https://github.com/OpenLoco/OpenLoco/pulls?q=is%3Apr+milestone%3Av25.11+interop+OR+global+OR+buffer+OR+loco_globals)
...
![OG_656](/assets/img/25.11/og_656.png)
