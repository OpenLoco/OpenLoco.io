...
the _current_ tile position is stored. If the two positions aren't identical, the new 'dragging' mode is activated. You'll now just see a map selection grid, showing what tiles will be filled with track pieces.
